...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { image: @hero.image, title_en: @hero.title_en, title_nb: @hero.title_nb, video: @hero.video } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { image: @hero.image, title_en: @hero.title_en, title_nb: @hero.title_nb, video: @hero.video } }
